...
- ([2ff7a07](https://github.com/angular/protractor/commit/2ff7a0771b6695dc49566ed81548b3fe2cebf11c)) 
  fix(Chrome Accessibility Plugin): resolving the checkin of AUDIT_FILE
...
- ([55a91ea](https://github.com/angular/protractor/commit/55a91ea137395891248db148df75dd6408c3b3a2)) 
  ...
  You may now use `config.resultJsonOutputFile` to specify a checkin for
...
- ([6249efe](https://github.com/angular/protractor/commit/6249efe57109d238044394636d623e0bd93dd4ad)) 
  ...
  Google changed selenium-server-standalone.jar's checkin and is returning 302 http module does
...
- ([54060b7](https://github.com/angular/protractor/commit/54060b7cef4eb2f4c184c360cef7c2eb25c0ff6a)) 
  ...
  the same format as $checkin.url().
...
- ([220d793](https://github.com/angular/protractor/commit/220d79372fb93d3b58c5131188b24e48be8176ab)), ([6603a7e](https://github.com/angular/protractor/commit/6603a7e964c8f1632db4790081a71648360cf1f9)) 
  chore(webdriver): update selenium version to 2.40.0 and download checkin
...
- ([a69ebc3](https://github.com/angular/protractor/commit/a69ebc3b783fb7bf42877a658498de90d3d196c3)) feat(runner): use selenium and chromedriver from the default checkin if nothing else is specified
...
- ([a1c91a2](https://github.com/angular/protractor/commit/a1c91a29af5c1e1f35744462ca16ef4b33ad6c48)) fix(config): Make all file paths in config files relative to the config file itself
  ...
  Breaking Change
  Previously, onPrepare and specs were relative to the checkin of the config,
  ...
  the same directory as the config checkin, you will need to change the paths of
...
- ([a54abfb](https://github.com/angular/protractor/commit/a54abfbbfd3b13be5144e64e52a267c73d409a81)) Spec paths in configuration files are now resolved from the checkin of the spec file instead of the current working directory when the command line is run.
